        ...
        <div className="prose prose-slate max-w-none">
          <section className="mb-10">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              Deze algemene voorwaarden zijn van toepassing op het gebruik van de website <strong>FietsAanZee.be</strong> en alle informatie, diensten en functionaliteiten die via deze website worden aangeboden.
            </p>
          ...
          <section className="mb-10">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              FietsAanZee.be biedt:
            </p>
            <ul className="list-disc pl-6 text-slate-600 space-y-2 mb-4">
              <li>Informatie over fietsroutes, paden en routes langs de Belgische kust</li>
              <li>Een overzicht van fietsverhuurpunten per badstad</li>
              <li>Een lijst van oplaadpunten en fietsstallingen</li>
              <li>Een platform met fietscafés en leuke tussenstops</li>
            </ul>
            <p className="text-slate-600 leading-relaxed">
          ...
          <section className="mb-10">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              Wij streven ernaar om de meest actuele en correcte informatie te verstrekken over fietsroutes, verhuurpunten en oplaadlocaties. 
          ...
          <section className="mb-10">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              Alle inhoud op FietsAanZee.be, inclusief teksten, afbeeldingen, logo's, en de structuur van de website, is beschermd door auteursrecht en andere intellectuele eigendomsrechten.
            </p>
            <p className="text-slate-600 leading-relaxed">
          ...
          <section className="mb-10">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              Ondernemers kunnen hun fietsvriendelijke zaak gratis laten vermelden op FietsAanZee.be. Voorwaarden:
            </p>
            <ul className="list-disc pl-6 text-slate-600 space-y-2 mb-4">
              <li>De verstrekte informatie moet correct en actueel zijn</li>
              <li>De zaak moet daadwerkelijk fietsvriendelijk zijn (fietsenstalling, oplaadpunt of fietsverhuur)</li>
          ...
          <section className="mb-10">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              FietsAanZee.be streeft naar een betrouwbare en veilige website, maar wij kunnen niet garanderen dat de website te allen tijde foutloos en ononderbroken beschikbaar is.
            </p>
            <p className="text-slate-600 leading-relaxed mb-4">
            ...
            <ul className="list-disc pl-6 text-slate-600 space-y-2">
              ...
              <li>Acties van fietsers of ondernemers die via onze website contact maken</li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="bg-sky-50 border-2 border-sky-200 rounded-2xl p-6">
              <p className="text-slate-900 font-bold mb-2">FietsAanZee.be</p>
